...
$packageName= 'apache-solr' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://archive.apache.org/dist/lucene/solr/6.3.0/solr-6.3.0.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'apache-solr*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
